...
namespace ClubProcessor.Tests
{
    public class CalendarImporterTests
    {
        ...
        public void ImportFromCsv_ShouldYieldSixEvents_WithCorrectProperties()
        {
            ...
            File.WriteAllText(
                testCsvPath,
                "Event Number,Date,Start time,Event Name,Round Robin Club,Miles,Location / Course,Hill Climb,Club Championship,Non-Standard 10,Evening 10,Hard Ride Series,Round Robin Event,Sheet Name,isCancelled,isPostponed\n" +
                ...
                "6,2025-05-06,18:30,Tur Langton/Hallaton 5+5mile TT,,10.0,Tur Langton/Hallaton,,Y,Y,,,,Event_06,Y,\n" +
                "23,2025-09-07,10:30:00,Interclub Hillclimb RFW,RFW,0.88,Nevill Holt ,Y,Y,Y,,,,Event_23,,Y\n");
            ...
            var expected = new[]
            {
                new {
                    ...
                    HillClimb = false, ClubChamp = true, NonStd10 = true, Evening10 = false, HardRide = true, RoundRobinEvent = false, Cancelled = false, Postponed = false
                },
                new {
                ...
                new {
                    ...
                    HillClimb = false, ClubChamp = true, NonStd10 = true, Evening10 = false, HardRide = false, RoundRobinEvent = false, Cancelled = false, Postponed = false
                },
                new {
                ...
                new {
                    ...
                    HillClimb = false, ClubChamp = true, NonStd10 = false, Evening10 = true, HardRide = false, RoundRobinEvent = true, Cancelled = false, Postponed = false
                },
                new {
                    ...
                    HillClimb = false, ClubChamp = true, NonStd10 = true, Evening10 = false, HardRide = false, RoundRobinEvent = false, Cancelled = true, Postponed = false
                },
                new {
                    ...
                    HillClimb = true, ClubChamp = true, NonStd10 = true, Evening10 = false, HardRide = false, RoundRobinEvent = false, Cancelled = false, Postponed = true
                }
            };
