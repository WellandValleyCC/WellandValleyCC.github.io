...
- The public repository for the club website
	...
	- Clone this from https://github.com/WellandValleyCC/WellandValleyCC.github.io - branch `master`
		- `master` branch - clone to: "C:\repos\wvcc\WellandValleyCC.github.io"
		- `gh-pages` branch - clone to: "C:\repos\wvcc\pages"
## Required Data Files
...
5. Confirm that the pipeline ran.
...
3. Trigger the `Process Club Data` action manually for the feature branch
...
4. Confirm the action runs successfully and processes the new events workbook.
5. Trigger the `Generate Static Site` action manually for the feature branch
  ![Triggering the Generate Static Site action manually](/images/trigger-Generate-Static-Site-on-feature-branch.png)
	- branch : `feature/2026-season-setup`
	- year : `2026`
6. Confirm the action runs successfully and generates a pull request for the new site:
  ![Pull request generated by Generate Static Site action](/images/trigger-Process-Club-Data-on-feature-branch.png)
7. Review the pull request to confirm everything looks correct.
  - Using the clone of the repo at `c:\repos\wvcc\pages`, check the commit log: 
  - `$ git log site-update-2026-20251210114434 -n 1 --stat`
```
Mike@DESKTOP-4NOPRLA MINGW64 /c/repos/wvcc/pages (site-update-2026-20251210114434)
$ git log site-update-2026-20251210114434 -n 1 --stat
commit 09931a201c8bd1574187eb9334c4be2c43885385 (HEAD -> site-update-2026-20251210114434, origin/site-update-2026-20251210114434)
Author: WellandValleyCC <25908894+WellandValleyCC@users.noreply.github.com>
Date:   Wed Dec 10 11:44:34 2025 +0000

    Automated site generation for 2026

 docs/competitions/2026-juniors.html         | 134 ++++++++++++++++++++++
 docs/competitions/2026-juveniles.html       | 134 ++++++++++++++++++++++
 docs/competitions/2026-league-1.html        | 134 ++++++++++++++++++++++
 docs/competitions/2026-league-2.html        | 134 ++++++++++++++++++++++
 docs/competitions/2026-league-3.html        | 134 ++++++++++++++++++++++
 docs/competitions/2026-league-4.html        | 134 ++++++++++++++++++++++
 docs/competitions/2026-league-Prem.html     | 134 ++++++++++++++++++++++
 docs/competitions/2026-nev-brooks.html      | 110 ++++++++++++++++++
 docs/competitions/2026-road-bike-men.html   | 134 ++++++++++++++++++++++
 docs/competitions/2026-road-bike-women.html | 134 ++++++++++++++++++++++
 docs/competitions/2026-seniors.html         | 169 ++++++++++++++++++++++++++++
 docs/competitions/2026-veterans.html        | 169 ++++++++++++++++++++++++++++
 docs/competitions/2026-women.html           | 134 ++++++++++++++++++++++
 docs/events/2026-event-01.html              |  51 +++++++++
 docs/events/2026-event-02.html              |  43 +++++++
 docs/events/2026-event-03.html              |  43 +++++++
 docs/events/2026-event-04.html              |  43 +++++++
 docs/events/2026-event-05.html              |  43 +++++++
 docs/events/2026-event-06.html              |  43 +++++++
 docs/events/2026-event-08.html              |  43 +++++++
 docs/events/2026-event-09.html              |  43 +++++++
 docs/events/2026-event-10.html              |  43 +++++++
 docs/events/2026-event-11.html              |  43 +++++++
 docs/events/2026-event-12.html              |  43 +++++++
 docs/events/2026-event-14.html              |  43 +++++++
 docs/events/2026-event-15.html              |  43 +++++++
 docs/events/2026-event-16.html              |  43 +++++++
 docs/events/2026-event-17.html              |  43 +++++++
 docs/events/2026-event-18.html              |  43 +++++++
 docs/events/2026-event-19.html              |  43 +++++++
 docs/events/2026-event-20.html              |  43 +++++++
 docs/events/2026-event-21.html              |  43 +++++++
 docs/events/2026-event-22.html              |  43 +++++++
 docs/events/2026-event-23.html              |  43 +++++++
 docs/events/2026-event-24.html              |  43 +++++++
 docs/events/2026-event-25.html              |  43 +++++++
 docs/events/2026-event-26.html              |  43 +++++++
 docs/events/2026-event-28.html              |  43 +++++++
 docs/preview.html                           |  77 +++++++------
 39 files changed, 2909 insertions(+), 39 deletions(-)
```
  - Serve the site locally using `dotnet serve -d C:\repos\wvcc\pages\docs -o`
  - Check the Events page to confirm the new events are listed correctly.
  - Check the first event to confirm the test rides are shown correctly.
  - Check other pages as necessary to confirm everything looks good.
